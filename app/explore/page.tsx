...
export default function ExplorePage() {
  ...
  const hasActiveFilters = selectedLocation !== "all" || statusFilter !== "all" || searchQuery.trim() !== ""
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="border-b border-border bg-card px-6 py-4">
          <div className="max-w-[1280px] mx-auto">
            <div className="flex items-center justify-between mb-3">
              <div>
                <h1 className="text-lg font-semibold text-foreground">Explorar obras</h1>
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="status-filter" className="text-xs text-muted-foreground font-medium whitespace-nowrap">
                  Status
                </label>
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger id="status-filter" className="w-40 h-8 text-xs">
            ...
            <div className="md:hidden">
              <Button
                ...
                className="text-xs gap-1.5 w-full bg-transparent"
              >
        ...
        <div className="flex-1 flex overflow-hidden" style={{ minHeight: "560px" }}>
          {/* Map */}
          ...
          <div className="w-96 shrink-0 border-l border-border bg-card flex-col hidden md:flex">
